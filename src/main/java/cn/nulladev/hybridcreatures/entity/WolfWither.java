...
public class WolfWither extends Monster implements PowerableMob, RangedAttackMob {
    private static final EntityDataAccessor<Integer> DATA_TARGET_A = SynchedEntityData.defineId(WolfWither.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> DATA_TARGET_B = SynchedEntityData.defineId(WolfWither.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> DATA_TARGET_C = SynchedEntityData.defineId(WolfWither.class, EntityDataSerializers.INT);
    private static final List<EntityDataAccessor<Integer>> DATA_TARGETS = ImmutableList.of(DATA_TARGET_A, DATA_TARGET_B, DATA_TARGET_C);
    private static final EntityDataAccessor<Integer> DATA_ID_INV = SynchedEntityData.defineId(WolfWither.class, EntityDataSerializers.INT);
    ...
    public WolfWither(EntityType<? extends WolfWither> p_31437_, Level p_31438_) {
    ...
    public WolfWither(Level level, double x, double y, double z) {
        this(EntityInit.WOLF_WITHER.get(), level);
        setPos(x, y, z);
    }

    public WolfWither(Level level, BlockPos position) {
    ...
    protected void registerGoals() {
        this.goalSelector.addGoal(0, new WolfWither.WitherDoNothingGoal());
    ...
    private void performRangedAttack(int p_31449_, double p_31450_, double p_31451_, double p_31452_, boolean p_31453_) {
        ...
        DogHead dogHead = new DogHead(this.level(), this, d3, d4, d5);
        dogHead.setOwner(this);
        if (p_31453_) {
            dogHead.setDangerous(true);
        }

        dogHead.setPosRaw(d0, d1, d2);
        this.level().addFreshEntity(dogHead);
    }
    ...
    public boolean hurt(DamageSource p_31461_, float p_31462_) {
        if (this.isInvulnerableTo(p_31461_)) {
            return false;
        } else if (!(p_31461_.getEntity() instanceof WolfWither)) {
    ...
    class WitherDoNothingGoal extends Goal {
        ...
        public boolean canUse() {
            return WolfWither.this.getInvulnerableTicks() > 0;
        }
    }
