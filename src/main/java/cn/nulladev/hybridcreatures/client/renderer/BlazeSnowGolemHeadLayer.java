...
@OnlyIn(Dist.CLIENT)
public class BlazeSnowGolemHeadLayer extends RenderLayer<BlazeSnowGolem, BlazeSnowGolemModel<BlazeSnowGolem>> {
    private final BlockRenderDispatcher blockRenderer;
    private final ItemRenderer itemRenderer;

    public BlazeSnowGolemHeadLayer(RenderLayerParent<BlazeSnowGolem, BlazeSnowGolemModel<BlazeSnowGolem>> p_234871_, BlockRenderDispatcher p_234872_, ItemRenderer p_234873_) {
        super(p_234871_);
        this.blockRenderer = p_234872_;
        this.itemRenderer = p_234873_;
    }

    public void render(PoseStack p_117494_, MultiBufferSource p_117495_, int p_117496_, BlazeSnowGolem p_117497_, float p_117498_, float p_117499_, float p_117500_, float p_117501_, float p_117502_, float p_117503_) {
        if (p_117497_.hasHead()) {
            ...
            if (!p_117497_.isInvisible() || flag) {
                ...
                ItemStack itemstack = new ItemStack(Blocks.SHROOMLIGHT);
                if (flag) {
